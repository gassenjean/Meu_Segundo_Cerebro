...
## Modelo Híbrido (Político vs Econômico)

A sociedade KabaK possui estrutura híbrida diferenciando poder de decisão e direitos econômicos.

### Poder de Decisão (Político)

**51% Sansom / 49% Jean (Família)**

- **51% Sansom:** Voto de minerva, palavra final em casos de impasse (usado em <1% dos casos)
- **49% Jean (Família):** Gestão operacional e executiva completa
- **Princípio:** 99% das decisões por consenso, 1% voto minerva se necessário

### Direitos Econômicos (Lucros/Dividendos)

**50% Sansom / 50% Jean (Família)**

- **50% Sansom:** Retorno sobre capital investido + conexões China
- **50% Jean (Família):** Retorno sobre know-how, operação e gestão
...
### Lado Sansom (50% Lucros / 51% Decisão)
...
### Lado Jean/Família (50% Lucros / 49% Decisão)
...
- **Investimento histórico:** Jean investiu 100% até agora
- **Criação marca/intangível:** Gassen + Kris criaram marca
- **Operação atual:** Jean + Kris (produção), Gassen (gestão)
- **Dedicação futura:** Quem dedica mais tempo ao projeto
...
**Modelo:**
- Fábrica Jean cobra Nova Sociedade com modelo "Custo + Margem"
- Custo real (matéria-prima + mão-de-obra + overhead)
- + Lucro mínimo: 5-10% (para manutenção/crescimento fábrica)
- **Abertura total:** Fábrica deve abrir todos os custos
- **Auditoria obrigatória:** Primeiros 6-12 meses

**Exclusividade:**
- 100% capacidade dedicada à Nova Sociedade
- Não pode produzir para terceiros sem autorização
- Prioridade absoluta para pedidos

**Capacidade:**
- Atual: 80.000 peças/mês (~27.000 kits)
...
- Avaliação: Após 6 meses de operação
...
- Por consenso entre Sansom e Jean/Família
- Maioria simples em assembleia
- Operação dia a dia: Gassen decide (operacional)
- Importação China: Sansom decide (operacional)
- Produção: Jean decide (operacional)

**2. Decisões Estratégicas (Requerem Consenso):**
- Investimentos acima de R$ [a definir com Dr. Alexandre]
...
- Se não houver consenso após [X dias/tentativas de mediação]
- Sansom (51%) tem voto de minerva
- **MAS:** Apenas em última instância (não é para usar sempre)
- Mediação obrigatória antes de usar voto minerva
...
- Período: Primeiros 6-12 meses (no mínimo)
...
- Relatórios: Para todos os sócios

**Abertura de Informações:**
- Sansom quer acesso total a custos, fornecedores, operação
- Jean/Família também quer transparência financeira completa
- Fábrica Jean: Abertura total de custos (auditável)

---

## Blindagem e Isolamento de Passivos

### Estrutura Proposta (Dr. Alexandre)

**KabaK (Novo CNPJ ou Reestruturação):**
- Detentora da marca
- Operação de vendas e e-commerce
- Caixa da operação
...
**Benefícios:**
- Protege investimento Sansom de passivos históricos
- Clara separação entre operação comercial e produção
- Flexibilidade para trocar fornecedor no futuro (se necessário)
- Contrato formal de prestação de serviço

---

## Condições de Saída (CRÍTICO)

**Princípio Sansom:** "Não quero briga no futuro. Vamos preparar o pior cenário desde o início."

### Saída Voluntária (Sócio Quer Sair)

**Processo:**
1. Direito de preferência aos sócios remanescentes
2. Valuation por múltiplo de lucro ou avaliação independente
3. Prazo pagamento: À vista ou parcelado (definir)
4. Venda para terceiros: Requer aprovação dos remanescentes

**Cláusula de Não Concorrência:**
- Prazo: 12-24 meses após saída
- Escopo: E-commerce fitness feminino (mesmo nicho)
- Geografia: Brasil

### Saída Involuntária (Morte/Incapacidade)

**Opções:**
1. Participação vai para herdeiros (sucessão)
2. OU empresa/sócios remanescentes compram (direito de preferência)
3. Seguro de vida obrigatório? (a definir)

### Dissolução da Sociedade

**Processo:**
1. Votação: Maioria ou unanimidade? (definir)
2. Divisão ativos/passivos proporcionalmente
3. Marca, clientes, estoque: Como dividir?
4. Fábrica Jean: Contrato rescindido com aviso prévio

### Resolução de Conflitos

**Antes de usar voto minerva Sansom:**
1. Mediação obrigatória (15-30 dias)
2. Arbitragem em câmara arbitral (se mediação falhar)
3. Último recurso: Judicial

**Objetivo:** Preservar amizade mesmo se negócio acabar

---

## Cronograma de Estruturação

### Fase 1: Definições Básicas (até 21/Jan)
- [ ] Sansom: Definir PF ou PJ
- [ ] Jean/Família: Definir estrutura 49%
- [ ] Todos: Confirmar capacidade investimento R$ 2,6M

### Fase 2: Estruturação Jurídica (até 11/Fev)
- [ ] Dr. Alexandre: Propor estrutura societária
- [ ] Dr. Alexandre: Elaborar contrato social
- [ ] Dr. Alexandre: Elaborar contrato prestação serviço (Fábrica)
- [ ] Revisão e ajustes por todos os sócios

### Fase 3: Formalização (até 28/Fev)
- [ ] Assinatura de contratos
- [ ] Registro empresa (se CNPJ novo)
- [ ] Abertura conta bancária
- [ ] Operacionalização completa

---

## Questões em Aberto (Dr. Alexandre)

1. [ ] Nova empresa ou usar CNPJ KabaK existente?
2. [ ] Regime tributário recomendado? (Simples/Lucro Presumido/Real)
3. [ ] Divisão interna família: Critérios e percentuais?
4. [ ] Alçadas de decisão: Valores limites para cada tipo?
5. [ ] Pró-labore: Quem recebe? Valores?
6. [ ] Distribuição lucros: Periodicidade? % Reinvestimento obrigatório?
7. [ ] Valuation para saída: Método e critérios?
8. [ ] Mediação/Arbitragem: Câmara e procedimentos?

---

**Documento vivo - atualizar após cada decisão jurídica**
**Próxima revisão:** Reunião Dr. Alexandre (21/Jan/2026)

**Nota:** Valores atualizados conforme auditoria 15/Jan/2026
Ver VALORES_OFICIAIS.md para fonte única da verdade
