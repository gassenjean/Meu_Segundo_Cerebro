---
criado: 2025-08-17T21:45:00-03:00
atualizado: 2025-08-17T21:45:00-03:00
---
...
```mermaid
graph LR
    A[Aula 7 V0] --> B[Setup Projeto]
    B --> C[Upload Contexto]
    C --> D[Prompts Naturais]
    D --> E[Protótipos BarberIA]
    E --> F[Export Next.js]
    F --> G[M4 Bolt MVP]
```
...
*"V0: De prompt para produção em minutos, não meses."*