...
Enquanto a maior parte do texto em uma nota deve ser lida por um ser humano, *metadados* é um texto que deve ser facilmente lido por um programa, por exemplo um [plugin da comunidade](https://publish.obsidian.md/help-pt-br/Estendendo+o+Obsidian/Plugins+da+comunidade) ou o próprio Obsidian.
...
Basicamente é é um formato de configuração amplamente usado que pode ser lido por humanos e máquinas. Cada parte dos metadados consiste em uma *chave* e um *valor* correspondente.
