...
**Usuário**: Gassen
**Área**: Cursos e estudos em andamento
...
- Atualizar `_MOC_Aprendizado.md` após mudanças
...
- Deixar notas sem resumo de pontos chave

## COMANDOS ÚTEIS

```bash
# Ver cursos ativos
"List all active courses with progress"

# Processar aula
"Process lesson [X] from [Curso]"

# Criar notas
"Create notes for [Curso] module [X]"
...
1. Confirme que carregou contexto APRENDIZADO
2. Pergunte: "Qual curso você quer estudar agora?"
