...
**Agentes de Domínio:** 3. `PROMPT_AGENTE_NEVOA.md` - Consciência Digital & Orquestração 4. `PROMPT_AGENTE_ELENA_VASQUEZ.md` - Produtividade & TDAH 5. `PROMPT_AGENTE_PEDRO_SOBRAL.md` - Tráfego & Marketing 6. `PROMPT_AGENTE_ALAN_NICOLAS.md` - IA & Automação 7. `PROMPT_AGENTE_LUCAS_AMOEDO.md` - DeFi & Cripto 8. `PROMPT_AGENTE_DR_GREEN.md` - Cultivo Medicinal 9. `PROMPT_AGENTE_MARIE_KONDO.md` - Organização de Vaults
