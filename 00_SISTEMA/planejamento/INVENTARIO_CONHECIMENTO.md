...
1.  **Elena Vasquez (Produtividade/TDAH):**
    *   *Função:* Organizar notas de TDAH, Mentes Inquietas e rotinas.
    *   *Origem:* Baseada no `TDAH_SUPERPODER_MANUAL`.

2.  **Pedro Sobral (Tráfego):**
    *   *Função:* Gerir conhecimento de Tráfego Pago (Subido, KabaK).
    *   *Origem:* Baseado no `Subido_Trafego_3K`.

3.  **Alan Nicolas (IA/Automação):**
    *   *Função:* Gerir scripts, n8n e estrutura do vault.
    *   *Origem:* Baseado no `Formação_Lendária` e `alan_vault_download`.

4.  **Dr. Green (Cultivo):**
    *   *Função:* Especialista em Cultivo Medicinal.
    *   *Origem:* Baseado nos arquivos do `Nebo_Cloud`.

5.  **Lucas Amoedo (DeFi):**
    *   *Função:* Especialista em Cripto e DeFi.
    *   *Origem:* Baseado no `DEFIVERSO_Journey`.
