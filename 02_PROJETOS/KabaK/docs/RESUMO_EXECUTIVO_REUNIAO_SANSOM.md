...
atualizado: 2026-01-14T13:30:00-03:00
tipo: resumo_executivo
prioridade: alta
status: consolidado
---

# RESUMO EXECUTIVO - Reunião Sansom (14/Jan/2026)

**Participantes:** Sansom, Jean (dono/CEO KabaK), Gassen (filho Jean, gestor), Kris (esposa Gassen, produção), Carol (breve)
**Duração:** ~2h30
**Objetivo:** Definir sociedade e estrutura para e-commerce Fitness Feminino

---

## 🎯 DECISÃO PRINCIPAL

**ACORDO DE SOCIEDADE FIRMADO VERBALMENTE**

- **Estrutura Decisão:** 51% Sansom / 49% Jean (voto minerva)
- **Estrutura Lucros:** 50% Sansom / 50% Jean (família)
- **Modelo:** Nova empresa (ou usar CNPJ existente Kabak)
- **Foco Inicial:** E-commerce Fitness Feminino (replicar modelo Atara)
- **Gestão:** Profissional (manter estrutura familiar operacional)
- **Divisão Interna Família:** Jean + Gassen + Kris (definir depois com Dr. Alexandre)
...
- **Gestão Marca:** Gassen (inovações, projetos, e-commerce)
- **Importação China:** Sansom (tecidos, matéria-prima)
- **Marketing:** Titanium (terceirizado)
- **Nova Empresa:** Sociedade Sansom (51%/50%) + Jean/Família (49%/50%)
  - Foco: E-commerce fitness feminino
  - Gestão: Profissional + estrutura familiar
...
- **Capacidade:** 80.000 peças/mês (~27.000 kits)
...
**Decisão:** 51% Sansom / 49% Jean (voto minerva apenas para desempate)
**Lucros:** 50% / 50% (distribuição igualitária)
...
| 2   | 3.000         | R$ 387.000   | -R$ 350.000   | Investimento |
| 3   | 8.000         | R$ 1.032.000 | -R$ 100.000   | Investimento |
| 4   | 12.000        | R$ 1.548.000 | +R$ 80.000    | **BREAK-EVEN** |
| 5   | 15.000        | R$ 1.935.000 | +R$ 350.000   | Lucro |
| 6   | 18.000        | R$ 2.322.000 | +R$ 600.000   | Lucro |

**ROI Projetado:** 155% em 12 meses
...
- **Agência:** Titanium (mesma que vamos contratar)
...
| Prazo entrega      | 15 dias          | 7-10 dias              | ✅ 50%   |
| Matéria-prima      | Limitada         | Ilimitada (China)      | ✅ 100%  |
| Infraestrutura     | Aluguel          | Prédio próprio (Jean)  | ✅ 30%   |
| Custo China        | Não tem          | Conexões Sansom        | ✅ 40%   |
| Marca              | 1 ano            | Pronta (18k followers) | ✅ 6 meses |

**CONCLUSÃO:** Podemos superar Atara em 12-18 meses
...
Logística:                R$  15.000 (10-15% receita)
Operacional/ADM:          R$  30.000
Jurídico/Contábil:        R$   5.000
--------------------------------
TOTAL FIXO:               R$ 150.000/mês
```
...
(-) Custo kit:            R$  45,00
(-) Logística (12%):      R$  15,48
(-) Impostos (2,5%):      R$   3,23
--------------------------------
MARGEM LÍQUIDA:           R$  65,29 (51% líquido)
```
...
- **Escopo:**
  ...
  - Atendimento/SAC (indicação de equipe)
...
- [ ] Definir estrutura societária (nova empresa ou CNPJ Kabak)
- [ ] Contrato social (51% Sansom / 49% Gassen+Kris)
- [ ] Definir alçadas de decisão
- [ ] Definir condições de saída
- [ ] Revisar contrato Titanium
...
- [ ] Criar planilha detalhada (receita, custos, lucro, caixa)
- [ ] Definir tamanho do investimento inicial
- [ ] Calcular custos reais de produção fábrica Jean (breakdown completo)
- [ ] Projetar fluxo de caixa mês a mês (12 meses)
...
- [ ] Pedir tecido poliéster 90/10 fundo preto
- [ ] Definir quantidade inicial (200k peças = ~70 toneladas)
- [ ] Negociar preço/prazo (custo alvo: R$ 30/kit = R$ 10/peça)
...
- [ ] Validar escopo e preço (R$ 60k/mês)
- [ ] Definir estratégia de lançamento
- [ ] Alinhar cronograma (1 mês setup)
- [ ] Assinar contrato
...
- [ ] Definir equipe mínima (atendimento, logística, financeiro)
- [ ] Estruturar logística (sistema, etiquetas, embalagem)
- [ ] Definir processo de produção na fábrica (lead time, controle qualidade)
- [ ] Contratar contador especializado em e-commerce
...
- [ ] Vender estoque existente (modal, algodão) via Shopee/Mercado Livre
- [ ] Avaliar entrada em outros nichos (infantil, sunga, fantasias)
- [ ] Manter separado da marca principal Kabak
...
| Gestão Marca       | Gassen               | Inovações, projetos, e-commerce           |
| Processo Produtivo | Kris                 | Operação produção, controle qualidade     |
| Matéria-prima      | Sansom               | Importação China, negociação              |
| Gestão Financeira  | Sansom               | Caixa, lucro, controladoria               |
| Marketing          | Titanium             | Campanhas, tráfego, conversão             |
...
- **Divisão Interna Família (50%):** Jean + Gassen + Kris
  - Percentuais internos: A definir com Dr. Alexandre
  - Considerar: Investimento Jean + Criação marca (Gassen+Kris)
- **Projeto Paralelo:** Gabriele Confecções Jurídico 2026 (estruturação familiar)
...
- **Mitigação:**
  ...
  - Começar conservador (1k kits/mês)
...
- **Mitigação:**
  ...
  - Aprender estratégias (in-house futuro)
...
- **Mitigação:**
  ...
  - Buffer de 30 dias no cronograma
...
- **Mitigação:**
  ...
  - Rede de costureiras externas (prontas)
...
- **Mitigação:**
  ...
  - Definir critérios claros: Investimento vs Criação vs Operação
  - Auditoria independente (transparência)
  - Gestão profissional (processos claros)
...
4. **Estoque:** Inteligente (tecido branco → estampar sob demanda)
...
4. **Infraestrutura:** Própria Jean (vs aluguel)
5. **Experiência:** 7+ anos B2B (Magazine Luiza, etc)
...
1. ✅ **Parceria Sólida:** Sansom (importação/financeiro) + Jean (CEO/produção) + Gassen (marca/gestão) + Kris (operação)
2. ✅ **Modelo Validado:** Atara provou que funciona (R$ 10M/mês em 1 ano)
3. ✅ **Vantagens Competitivas:** Custo China, capacidade produtiva, experiência 7+ anos
4. ✅ **Marca Pronta:** Kabak existe (Jean investiu, Gassen+Kris criaram)
5. ✅ **Infraestrutura:** Fábrica KabaK pronta, experiente, 80k peças/mês
6. ⏳ **Execução Rápida:** Tecido jan → lançamento mai (4 meses)
...
- **Pragmático:** Discussão de números, riscos, contingências
...
- **Sansom:** "Quero auditoria primeiros 6-12 meses para segurança"
- **Jean:** Dono/CEO atual, validou capacidade produtiva e investimento
- **Gassen:** "Temos tudo para superar Atara" (marca criada por ele+Kris)
...
- **Jean (Família):** Sócio 49% (decisão), 50% (lucros)
  - Representa: Jean + Gassen + Kris
  - **Divisão interna 50%:** A definir com Dr. Alexandre
  - **Projeto paralelo:** Gabriele Confecções Jurídico 2026
...
1. **Dr. Alexandre (jurídico):**
   ...
   - Prazo: 7-15 dias
2. **Dr. Alexandre (estruturação familiar):**
   - Objetivo: Divisão interna Jean + Gassen + Kris
   - Projeto: Gabriele Confecções Jurídico 2026

---

**Documento criado:** 14/Jan/2026
**Responsável:** Gassen (via Claude Code)
**Status:** Consolidado (base transcrição completa)
**Próxima Revisão:** Após reunião Dr. Alexandre
**Participantes Reunião:** Sansom, Jean (dono/CEO KabaK), Gassen (filho Jean, gestor), Kris (esposa Gassen, produção), Carol (breve)
