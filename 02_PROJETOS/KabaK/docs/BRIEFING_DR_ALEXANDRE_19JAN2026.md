...
# BRIEFING JURÍDICO - Dr. Alexandre (ATUALIZADO 19/Jan/2026)

**Solicitante:** Gassen Jean Bou Karim
**Projeto:** Sociedade KabaK + Sansom (E-commerce + Marketplaces + Outlet Físico)
**Data Reunião Societária:** 14/Jan/2026
**Última revisão:** 19/Jan/2026 (Titanium aprovado + Custos confirmados)
**Reunião Dr. Alexandre:** A AGENDAR (URGENTE)
...
Para explorar:
1. **E-commerce** de moda fitness feminina (Shopify)
2. **Marketplaces** (Shopee, Mercado Livre, TikTok Shop)
3. **Outlet físico** em rodovia (loja própria)

Com investimento de **R$ 2.096.300** em 6 meses, projeção de faturamento **R$ 3-5M/mês** e ROI **155% em 12 meses** (método conservador).

**NOVIDADES (desde briefing 15/Jan):**
- ✅ **Titanium APROVADO** por Sansom (19/Jan - verbal)
- ✅ **Custos tecido CONFIRMADOS:** R$ 5/peça = R$ 15/kit (Jean)
- ✅ **Custos fabricação CONFIRMADOS:** R$ 10/peça = R$ 30/kit (Jean)
- ✅ **Margem mantida:** 45,3% (custo total produto = R$ 48/kit)
- ✅ **Canais expandidos:** Incluir Shopee, Mercado Livre, TikTok Shop
- ✅ **Primeira remessa China:** 2 toneladas = ~3.333 kits (final Março/2026)
...
**E-commerce + Marketplaces + Outlet** vendendo **kits de roupa fitness feminina** para consumidoras finais classe C via:

**ONLINE:**
- Loja própria Shopify (principal)
- Shopee (marketplace)
...
**FÍSICO:**
- Outlet em rodovia (alto fluxo)
- Validado: R$ 20k/dia em Dez/2024

### Modelo de Negócio

**Produto:** Kit 3 peças (calça legging + top + short) por **R$ 129**

**CUSTOS CONFIRMADOS (19/Jan):**

| Item | Custo/peça | Custo/kit (3 peças) |
|------|-----------|---------------------|
| Tecido China | R$ 5 | R$ 15 ✅ |
| Fabricação Jean | R$ 10 | R$ 30 ✅ |
| Embalagem | R$ 1 | R$ 3 |
| **TOTAL PRODUTO** | **R$ 16** | **R$ 48** |

**Margem bruta:** 45,3% mantida (conforme estimativa original)
...
- Multi-canal (online + físico + marketplaces)

### Estrutura Operacional

```
NOVA SOCIEDADE (OMNICHANNEL)
├── Sócios:
...
│
├── Atividades:
│   ├── Comércio eletrônico (Shopify)
│   ├── Comércio em marketplaces (Shopee, ML, TikTok)
│   ├── Comércio varejista físico (Outlet)
...
│   ├── Capacidade: 80k peças/mês (atual) → 240k peças/mês (máxima)
│   ├── Exclusividade: 100% para nova sociedade
│   └── Custo fabricação confirmado: R$ 10/peça (R$ 30/kit)
│
├── COMPRA MATÉRIA-PRIMA DE:
│   └── Fornecedores China (via Sansom)
│       ├── Tecido: R$ 25/kg (R$ 5/peça, R$ 15/kit) ✅ CONFIRMADO
│       ├── Primeira remessa: 2 toneladas (10k peças)
│       └── Entrega: Final Março/2026
│
└── CONTRATA SERVIÇOS DE:
    └── Titanium (Agência Marketing) ✅ APROVADO 19/JAN
        ├── Setup: R$ 50k (desconto R$ 10k conseguido)
        ├── Mensalidades: R$ 45-60k/mês (escalonadas)
        └── Escopo: E-commerce + Outlet + Marketplaces (full service)
```

**IMPORTANTE:** KabaK atual (Jean dono) produz para nova sociedade. Modelo comercial: Prestação de serviço com custo + margem mínima (5-10%).
...
- Quer gestão profissional + estrutura familiar operacional
- Quer estrutura clara para evitar conflitos futuros
- ✅ **APROVOU Titanium em 19/Jan** (verbal, documentos aguardados)
- ✅ **CONFIRMOU custos tecido:** R$ 25/kg landed cost
...
- Fábrica própria em MG, 80k peças/mês (até 240k peças/mês)
...
**CONFIRMAÇÕES (19/Jan):**
- ✅ **Custo fabricação:** R$ 10/peça (costura + sublimação) = R$ 30/kit
- ✅ **Custo tecido:** R$ 5/peça (R$ 25/kg ÷ 5 peças) = R$ 15/kit
- ✅ **Primeira remessa:** 2 toneladas China (10k peças = ~3.333 kits)
...
- Interface marketplaces (Shopee, ML, TikTok)
- Apoio produção
...
**Lado Jean = 50% lucros da nova sociedade = R$ 1.048.150 investimento**
...
### **PERGUNTA CRÍTICA PARA DR. ALEXANDRE:**
...
- Custo-benefício
- Regime tributário (qual o melhor?)
- **Multi-canal:** E-commerce + Outlet + Marketplaces (CNAEs adequados?)
...
- **Sansom:** [A definir se PF ou PJ] - 51% decisão / 50% lucros
- **Jean:** [PF ou PJ] - parte dos 49% decisão / 50% lucros
- **Gassen:** [PF ou PJ] - parte dos 49% decisão / 50% lucros
- **Kris:** [PF] - parte dos 49% decisão / 50% lucros
- Qualificação completa (RG, CPF, endereço, estado civil, regime bens)

#### B. Objeto Social

- **Principal:** Comércio varejista de artigos do vestuário e acessórios
  - Via internet (e-commerce)
  - Via marketplaces (Shopee, Mercado Livre, TikTok Shop)
  - Via estabelecimento físico (outlet)

- **Secundário:**
  - Comércio atacadista de artigos do vestuário
  - Importação de tecidos e matérias-primas
  - Logística e distribuição
  - [Outros CNAEs relevantes para marketplaces e social commerce?]

**IMPORTANTE:** Garantir CNAEs que permitam:
- Vendas por e-commerce próprio
- Vendas por marketplaces de terceiros
- Vendas por social commerce (TikTok Shop)
...
- **Total:** R$ 2.096.300
- **Divisão Decisão (Político):**
  - Sansom: 51%
  - Jean+Gassen+Kris: 49% (divisão interna a definir)

- **Divisão Lucros (Econômico):**
  - Sansom: 50% = R$ 1.048.150
  - Jean+Gassen+Kris: 50% = R$ 1.048.150 (divisão interna a definir)
...
- Por consenso entre Sansom e Jean+Gassen+Kris
...
- Aumento de capital
- **Abertura de novos canais de venda** (novos marketplaces)
- **Expansão para lojas físicas adicionais**
...
- **Proporcional:** 50% Sansom / 50% Jean+Gassen+Kris
- **NÃO proporcional à decisão** (que é 51/49)
...
- Mercado Livre: 50/50
- TikTok Shop: 50/50
- **TODOS os canais:** Mesma divisão 50/50 lucros

#### F. Canais de Venda (Especificar no Contrato)

**Incluir cláusula específica:**

"A sociedade operará nos seguintes canais de vendas, com divisão de lucros de 50% para cada lado (Sansom / Jean+Gassen+Kris) em TODOS os canais:"

| Canal | Status | Divisão Lucros |
|-------|--------|----------------|
| E-commerce próprio (Shopify) | Ativo | 50/50 |
| Outlet físico (rodovia) | Ativo | 50/50 |
| Shopee | A implementar | 50/50 |
| Mercado Livre | A implementar | 50/50 |
| TikTok Shop | A implementar | 50/50 |
| Outros marketplaces | Requer aprovação | 50/50 |

**IMPORTANTE:**
- Sansom pediu explicitamente incluir TODOS os canais
- Evita disputas futuras sobre "qual canal pertence a quem"
- Decisão sobre novos canais: Requer consenso (decisão estratégica)

#### G. Auditoria e Transparência
...
- Escopo: Contabilidade, fluxo caixa, estoque, fornecedores, **vendas por canal**
- Auditor: Independente (escolhido como? Por consenso?)
- Custo: Quem paga? (empresa ou divide?)
- Relatórios: Para quem? (todos sócios? Conselho?)

**Abertura de Informações:**

- Sansom quer acesso total a custos, fornecedores, operação, **vendas por canal**
- Jean+Gassen+Kris também querem transparência financeira
- Como garantir isso no contrato?
- **Dashboard em tempo real?** (vendas/canal, estoque, custos)

#### H. Condições de Saída (MUITO IMPORTANTE)
...
- Quem fica com marca, clientes, estoque, **contratos marketplaces**?
...
**OU:** Isso vai em contrato separado? (veja seção específica abaixo)
...
- **CONTRATANTE:** Nova sociedade (51% Sansom + 49% Jean+Gassen+Kris)
- **CONTRATADA:** Fábrica Jean (pessoa jurídica de Jean, pai de Gassen)

**Objeto:**
Prestação de serviços de produção/fabricação de peças de vestuário fitness (corte, costura, sublimação, acabamento, embalagem).

**Modelo Remuneração:**

**CONFIRMADO (19/Jan):**
- **Custo de fabricação:** R$ 10/peça (R$ 30/kit de 3 peças)
- **Composição:** Costura + Sublimação + Mão-de-obra + Overhead
...
```
Exemplo (kit 3 peças):
Custo matéria-prima própria fábrica: R$ X
Mão-de-obra: R$ Y
Overhead (energia, aluguel, etc): R$ Z
----------------------------------------
Custo real: R$ X+Y+Z
Margem (5-10%): R$ (X+Y+Z) × 0.05-0.10
----------------------------------------
Preço final/kit: R$ 30,00 (base confirmada)
```
...
- Capacidade atual: 80k peças/mês (~27k kits/mês)
- Capacidade máxima: 240k peças/mês (~80k kits/mês)
...
- Jean (fábrica) é também sócio parte dos 49%
...
### 3. Acordo de Sócios (Recomendado?)
...
- Cláusula de não concorrência (mais detalhes)
- **Divisão interna 49%** (Jean+Gassen+Kris)
...
- **Marketplace:** Alguns marketplaces exigem emissão de NF específica
...
- **Multi-canal:** Tributação varia por canal? (e-commerce vs marketplace vs loja física?)

**PERGUNTA DR. ALEXANDRE:**
**"Qual regime tributário você recomenda para faturamento projetado R$ 3-5M/mês em múltiplos canais (e-commerce + outlet + marketplaces)?"**
...
- Shopee, ML, TikTok Shop têm tributação diferente?
- Como otimizar?
...
- **Landed cost confirmado:** R$ 25/kg (R$ 5/peça)
...
- **ICMS:** Quanto? (varia por estado destino?)
  - E-commerce próprio: ?%
  - Outlet físico: ?%
  - Marketplaces: ?% (eles recolhem ou empresa?)

- **PIS/COFINS:** Quanto?
- **IRPJ:** Quanto?
- **CSLL:** Quanto?
- **ISS:** Aplicável? (e-commerce tem serviço? Marketplace?)

**TOTAL:** Carga tributária efetiva = ?% do faturamento

**URGENTE:** Sansom+Gassen precisam disso para validar planilha financeira

---

## 🏛️ LOCALIZAÇÃO DA EMPRESA
...
- **Outlet:** Pode ser endereço do outlet físico?

**Recomendação Dr. Alexandre?**
...
**Provavelmente não (empresa início), mas perguntar Dr. Alexandre.**

---

## 🚨 RISCOS JURÍDICOS A ENDEREÇAR
...
- Jean (fábrica) é pai de Gassen (sócio 49%)
- Jean (fábrica) é TAMBÉM sócio (parte dos 49%)
- Sansom (51%) pode questionar: "Jean favorecendo a si próprio?"
...
- Jean se abstém de votos sobre Fábrica Jean? (se aplicável)
- **Custos confirmados:** R$ 10/peça (R$ 30/kit) - documentar oficialmente

**PERGUNTA DR. ALEXANDRE:**
"Que cláusulas protegem Sansom desse risco e garantem que Jean não está 'cobrando demais' da nova sociedade?"
...
- Mediação obrigatória (antes de qualquer disputa formal)
- **Dashboard em tempo real** (vendas/canal, custos, estoque)

**Importante:** Dr. Alexandre explicar bem para Sansom todos os pontos críticos.
...
**PERGUNTA DR. ALEXANDRE:**
"Como isolar nova sociedade de eventuais passivos Fábrica Jean?"
...
- Cláusula: Sansom deve "transferir" relacionamento (se sair)

**CONFIRMAÇÃO (19/Jan):**
- Primeira remessa: 2 toneladas (10k peças)
- Custo: R$ 25/kg landed cost
- Entrega: Final Março/2026

**PERGUNTA DR. ALEXANDRE:**
"Como estruturar importações para não depender 100% de Sansom pessoa física?"
...
### 6. Marketplaces (Novos Riscos)

**Risco:**

- Shopee, ML, TikTok Shop têm contratos próprios (termos de uso)
- Empresa pode ser banida se violar termos
- Como proteger sociedade de banimento de um canal?

**Mitigação:**

- Compliance rigoroso com termos de cada marketplace
- Backup de canais (se Shopee banir, temos ML)
- Diversificação (não depender de 1 só marketplace)

**PERGUNTA DR. ALEXANDRE:**
"Precisamos prever algo específico no contrato social sobre marketplaces?"
...
**1. Reunião Inicial (URGENTE - Agendar ASAP):**
...
- Definir prazos e honorários
- Alinhar expectativas

**2. Proposta de Estruturação (Até 1 semana após reunião):**
...
**3. Minutas Contratos (Até 3 semanas após proposta aprovada):**
...
**4. Revisão com Sócios (1 semana):**

- Sansom revisa e aprova
- Jean+Gassen+Kris revisam e aprovam
- Ajustes finais (se necessário)

**5. Assinatura (1 semana):**

- Assinatura formal
- Registro (se necessário)
- Arquivamento Junta Comercial (se aplicável)

**6. Operacionalização (2 semanas):**

- Abertura conta bancária
- Inscrições estaduais (marketplace, outlet)
- Alvarás (se necessário)
- Outros docs operacionais

**CRÍTICO:** Tecido China chega final Março/2026. Precisamos estrutura jurídica PRONTA para receber mercadoria e iniciar produção.

---

## 📞 PRÓXIMOS PASSOS

### 1. Gassen - Ações Imediatas

**Até 20/Jan:**

- [ ] Agendar reunião Dr. Alexandre (URGENTE)
- [ ] Enviar este briefing para Dr. Alexandre
- [ ] Levantar situação marca Kabak (INPI)
- [ ] Levantar documentação Fábrica Jean (CNPJ, passivos)

### 2. Sansom - Definições Pendentes

**Até 22/Jan:**

- [ ] Decidir: Entra como PF ou PJ?
- [ ] Se PJ: Qual empresa? (docs necessários)
- [ ] Confirmar forma de integralização (integral? Parcelado?)

### 3. Dr. Alexandre - Documentação Necessária

**Informar o que precisa:**

- RG, CPF, Comprovante residência (todos sócios)
- Certidões (quais?)
- Se PJ: Contrato Social, CNPJ, etc.
- Fábrica Jean: CNPJ, Contrato Social, Certidões
- Marca Kabak: Registro INPI
- Outros documentos?
...
**Dr. Alexandre, favor orçar:**

1. **Estruturação jurídica completa:**
   - Consultoria inicial
   - Elaboração contratos (social + prestação serviço + outros)
   - Revisões (até X rounds?)
   - Registro/arquivamento

2. **Assessoria contínua (se aplicável):**
   - Disponibilidade para dúvidas
   - Assembleias (participação?)
   - Alterações futuras (custam quanto?)

3. **Forma de pagamento:**
   - À vista (desconto?)
   - Parcelado (quantas vezes?)
   - Empresa paga ou sócios dividem?
...
3. [ ] Carga tributária efetiva estimada? (% do faturamento por canal)
4. [ ] Precisa Acordo de Sócios além do Contrato Social?
5. [ ] Onde registrar empresa? (MG? SP? Faz diferença?)
6. [ ] **CNAEs adequados para e-commerce + outlet + marketplaces?**

### Conflitos

7. [ ] Como proteger Sansom do conflito de interesse (Fábrica Jean = pai de Gassen = também sócio)?
8. [ ] Como isolar nova sociedade de passivos Fábrica Jean?
9. [ ] Como estruturar importação China (não depender Sansom PF)?
10. [ ] Qual a situação marca Kabak? (transferir? Regularizar?)

### Saída

11. [ ] Como estruturar saída voluntária (valuation? Prazo pagamento?)
12. [ ] Como estruturar saída involuntária (morte? Incapacidade?)
13. [ ] Como estruturar dissolução (se negócio não der certo?)
14. [ ] Cláusula não concorrência (escopo? Prazo?)

### Governança

15. [ ] Como definir alçadas de decisão? (quem decide o quê?)
16. [ ] Auditoria obrigatória (como incluir no contrato?)
17. [ ] Mediação/arbitragem obrigatória (antes de judicial)?
18. [ ] **Como garantir transparência por canal de venda?**

### Operacional

19. [ ] Benefício fiscal 2,5% MG (é real? Como funciona?)
20. [ ] Pró-labore (quem recebe? Obrigatório? Quanto?)
21. [ ] Distribuição lucros (periodicidade? Reserva obrigatória?)
22. [ ] **Marketplaces: Alguma cláusula especial no contrato social?**
23. [ ] **Outlet físico: Pode operar com mesmo CNPJ ou precisa filial?**

### Prazo e Custo

24. [ ] Prazo total para tudo pronto e registrado? (dias/semanas?)
25. [ ] Honorários totais? (estruturação completa)
26. [ ] Forma de pagamento? (à vista? Parcelado?)

### Multi-Canal (NOVO)

27. [ ] **Como incluir múltiplos canais no contrato social?**
28. [ ] **Tributação varia por canal? (e-commerce vs outlet vs marketplace)**
29. [ ] **Precisa licenças diferentes para cada canal?**
30. [ ] **Como proteger sociedade se um canal for descontinuado?**
...
1. [ ] Este briefing (BRIEFING_DR_ALEXANDRE_19JAN2026.md)
2. [ ] VALORES_OFICIAIS.md (custos confirmados)
3. [ ] STATUS_ATUAL.md (contexto completo projeto)
4. [ ] Resumo Executivo Reunião Sansom (14/Jan)
5. [ ] Resumo Ligação Sansom (15/Jan - Outlet + Custos)
6. [ ] Resumo Reunião Titanium (16/Jan - Desconto + Aprovação)
7. [ ] Documentos pessoais sócios (quando solicitado)
8. [ ] Documentos Fábrica Jean (quando solicitado)
9. [ ] Situação Marca Kabak INPI (se tiver)
...
- **Multi-canal:** E-commerce + Outlet + 3 Marketplaces

**ATUALIZAÇÕES CRÍTICAS (desde último briefing 15/Jan):**

- ✅ **Titanium APROVADO** (19/Jan - Sansom confirmou verbal)
- ✅ **Custos CONFIRMADOS:** Tecido R$ 15/kit + Fabricação R$ 30/kit = Total R$ 48/kit
- ✅ **Margem mantida:** 45,3% (conforme projeção original)
- ✅ **Canais expandidos:** Incluir Shopee, Mercado Livre, TikTok Shop no contrato
- ✅ **Primeira remessa:** 2 toneladas China chegando final Março/2026
...
- "Amizade tem que continuar mesmo se negócio acabar"
- **"TODOS os canais devem estar no contrato (50/50 em tudo)"** ⭐ NOVO
...
2. Resolva conflito de interesse (Fábrica Jean = pai + sócio)
3. Defina saídas sem "briga"
4. Otimize tributariamente
5. Permita crescimento rápido e saudável
6. **Cubra TODOS os canais de venda (online + físico + marketplaces)** ⭐ NOVO

**Prazo é apertado:**

- Tecido China chegando: **Final Março/2026**
- Produção estoque: Março-Abril/2026
- Lançamento oficial: **Mai/2026**
- **URGENTE:** Estrutura jurídica ANTES do tecido chegar

**Contamos com você para estruturar isso da melhor forma possível.**
...
Por gentileza, retorne com:

1. **Disponibilidade para reunião inicial** (presencial ou online)
   - Sugestão: Semana de 20-24/Jan/2026
   - Duração estimada: 1h30-2h
   - Participantes: Dr. Alexandre + Gassen + Kris (+ Sansom se possível)

2. **Documentação necessária** para iniciar estruturação
   - Lista completa de documentos dos sócios
   - Documentos Fábrica Jean (CNPJ, certidões)
   - Outros documentos relevantes

3. **Estimativa de prazo** para estrutura jurídica completa
   - Desde reunião inicial até contratos assinados
   - Crítico: Tecido China chega final Março/2026

4. **Estimativa de honorários** (preliminar)
   - Estruturação completa
   - Forma de pagamento

**Aguardamos seu retorno o mais breve possível para agendarmos a reunião inicial.**

**Prazo crítico:** Tecido chegando em 8-10 semanas. Precisamos estrutura jurídica PRONTA.
...
| **Divisão** | 50/50 (R$ 1.048.150 cada lado) |
| **Poder Decisão** | 51% Sansom / 49% Jean+Gassen+Kris |
| **Faturamento Projetado** | R$ 3-5M/mês |
| **ROI Ano 1** | 155% (conservador) |
| **Break-even** | Mês 4 (Agosto/2026) |
| **Margem Bruta** | 45,3% ✅ |
| **Produto** | Kit 3 peças R$ 129 |
| **Custo Produto** | R$ 48/kit (R$ 15 tecido + R$ 30 fabric + R$ 3 emb) ✅ |

### Sócios

| Sócio | Decisão | Lucros | Papel | Investimento |
|-------|---------|--------|-------|--------------|
| **Sansom** | 51% | 50% | Gestão financeira + Importação China | R$ 1.048.150 |
| **Jean** | Parte 49% | Parte 50% | CEO + Produção (fábrica) | Parte R$ 1.048.150 |
| **Gassen** | Parte 49% | Parte 50% | Gestor marca + E-commerce | Parte R$ 1.048.150 |
| **Kris** | Parte 49% | Parte 50% | Desenvolvimento produto + Operação | Parte R$ 1.048.150 |
...
| Canal | Status | Divisão Lucros |
|-------|--------|----------------|
| E-commerce próprio | Ativo | 50/50 ✅ |
| Outlet físico | Ativo | 50/50 ✅ |
| Shopee | A implementar | 50/50 🆕 |
| Mercado Livre | A implementar | 50/50 🆕 |
| TikTok Shop | A implementar | 50/50 🆕 |
...
| Item | Status |
|------|--------|
| Titanium (Marketing) | ✅ APROVADO 19/Jan |
| Custo Tecido China | ✅ CONFIRMADO R$ 15/kit |
| Custo Fabricação Jean | ✅ CONFIRMADO R$ 30/kit |
| Margem Produto | ✅ 45,3% mantida |
| Primeira Remessa China | ✅ 2 ton (10k pçs) - Mar/2026 |
| Estrutura Jurídica | ⏳ PENDENTE - Dr. Alexandre |
| Contrato Social | ⏳ PENDENTE - Dr. Alexandre |
| Lançamento | 🎯 Mai/2026 |

### Urgências

1. **🔴 CRÍTICO:** Agendar reunião Dr. Alexandre (estrutura jurídica)
2. **🔴 CRÍTICO:** Definir regime tributário (multi-canal)
3. **🟡 IMPORTANTE:** Resolver conflito interesse (Fábrica Jean)
4. **🟡 IMPORTANTE:** Estruturar importação China (não depender Sansom PF)
5. **🟢 NECESSÁRIO:** Definir divisão interna 49% (Jean+Gassen+Kris)

---

**Documento criado:** 19/Jan/2026
**Última revisão:** 19/Jan/2026 (Titanium aprovado + Custos confirmados)
**Criado por:** Gassen (via Claude Code - Agente KabaK)
**Baseado em:**
- Reunião 14/Jan/2026 (Sansom)
- Ligação 15/Jan/2026 (Outlet + Custos)
- Reunião 16/Jan/2026 (Titanium)
- Confirmações 19/Jan/2026 (Custos finais)
- VALORES_OFICIAIS.md (fonte única verdade)

**Confidencialidade:** ALTA (informações financeiras e estratégicas sensíveis)

**Versão:** 2.0 (Atualização completa vs v1.0 de 15/Jan)

---

**THIS BRIEFING SUPERSEDES ALL PREVIOUS VERSIONS**
