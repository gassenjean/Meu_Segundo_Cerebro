...
# VALORES OFICIAIS - KabaK Projeto
...
Este documento é a **FONTE OFICIAL** de todos os valores financeiros e estruturais do projeto KabaK.

**Regra de Ouro:** Se houver divergência entre qualquer documento e este, **este documento prevalece**.
...
```
Prejuízo Mês 1 (Mai/2026):      R$   116.575
Prejuízo Mês 2 (Jun/2026):      R$     9.725
----------------------------------------
TOTAL DÉFICIT:                  R$   126.300
```
...
- **51% Sansom:** Voto de minerva (palavra final em impasses - <1% dos casos)
...
**TODOS entram no contrato social:**

1. **Jean Bou Karim** (pai)
   - CEO, dono fábrica Gabriele Confecções
   - Responsável: Produção, qualidade, capacidade produtiva
   - % dos 49%: A definir com Dr. Alexandre

2. **Gassen Jean Bou Karim** (filho)
   - Gestor marca, e-commerce, inovações
   - Responsável: Marca, Shopify, interface marketing
   - % dos 49%: A definir com Dr. Alexandre

3. **Kris** (esposa Gassen)
   - Desenvolvimento produto, operação produtiva
   - Responsável: Protótipos, processo produtivo, qualidade
   - % dos 49%: A definir com Dr. Alexandre

**Decisão Pendente:** Dr. Alexandre vai propor divisão justa entre os 3 (critérios: investimento histórico, criação marca, dedicação futura).
...
```
BREAK-EVEN OFICIAL: Mês 4 (Agosto/2026)
```

**Justificativa:** Conservador e seguro. Planilha detalhada indica possível mês 3, mas usamos mês 4 para margem de segurança.
...
**Mensal (após estabilização - mês 7+):**
- Vendas: 20.000 kits/mês
- Receita: R$ 2.580.000/mês
- Lucro: R$ 913.500/mês
...
- **Nome:** Kit Fitness Feminino
- **Composição:** 3 peças (calça legging + top + short)
...
- **Atual:** 80.000 peças/mês (~26.667 kits/mês)
- **Máxima:** 240.000 peças/mês (~80.000 kits/mês)
- **Escalabilidade:** 40 costureiras → até 400 se necessário
...
- Progresso: 45%
- Crítico: Dr. Alexandre + Pedido China + Planilha financeira

**Fase 2: Produção (Mar-Abr/2026)**
- Receber tecido China
- Produzir estoque inicial
- Setup Shopify

**Fase 3: Lançamento (Mai/2026)**
- **LANÇAMENTO OFICIAL:** 01/Mai/2026
- Meta mês 1: 1.000 kits

### Deadlines Críticos

- **17/Jan:** Agendar Dr. Alexandre
- **21/Jan:** Sansom pedir tecido China (URGENTE)
- **21/Jan:** Planilha financeira validada
- **28/Jan:** Reunião Titanium comercial
- **11/Fev:** Contratos assinados
- **01/Mai:** Lançamento oficial
...
**Motivo:** Auditoria encontrou 25 divergências entre documentos

**Decisões Tomadas:**
1. Investimento oficial: R$ 2.106.300 (não R$ 2.6M arredondado)
2. Divisão: 50/50 investimento E lucros (51/49 só decisão)
3. ROI: 155% (não 288%, não 356%, não 5.940%)
4. Break-even: Mês 4 (conservador, não mês 3)
5. Sócios 49%: Jean+Gassen+Kris (todos entram)

**Documentos Corrigidos:**
- STATUS_ATUAL.md
- README.md
- DASHBOARD.md
- PLANILHA_SANSOM_SIMPLES.md

**Pendente Correção:**
- RESUMO_FINANCEIRO_SANSOM.md
- PROXIMOS_PASSOS_SOCIEDADE_SANSOM.md
- BRIEFING_DR_ALEXANDRE.md
- Skill references (.claude/skills/kabak/)

---

## ✅ CHECKLIST ANTES DE ATUALIZAR QUALQUER DOC

Antes de atualizar qualquer documento do projeto KabaK:
...
**Próxima Revisão:** Após reunião Dr. Alexandre (21/Jan/2026)
**Responsável Atualização:** Gassen
**Aprovação Mudanças:** Requer consenso Sansom + Jean+Gassen+Kris
