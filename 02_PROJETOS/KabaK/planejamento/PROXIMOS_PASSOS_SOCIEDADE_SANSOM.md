...
## 📋 SEMANA 1-2 (14-28/JAN) - CRÍTICO

### 🔴 PRIORIDADE 1: Estrutura Jurídica

**Responsável:** Dr. Alexandre (via Gassen)
...
2. **Dr. Alexandre:** Propor estrutura jurídica
   - Opção A: Nova empresa (CNPJ novo)
   - Opção B: Usar CNPJ Kabak existente
   - Definir: Regime tributário (Simples? Lucro Presumido?)

3. **Dr. Alexandre:** Elaborar contratos
   - Contrato Social (51% Sansom / 49% Gassen+Kris)
   - Contrato Prestação Serviço (Fábrica Jean → Nova Empresa)
   - Cláusulas críticas:
     - Alçadas de decisão
     - Condições de saída
...
- [ ] Definição PF/PJ todos os sócios (até 21/Jan)

---

### 🔴 PRIORIDADE 2: Pedido Tecido China
...
1. **Sansom:** Contatar fornecedores China
   ...
   - Pedir amostras (se possível express)

2. **Sansom:** Negociar condições
   - Prazo: Até 21/Jan
   - Preço: Alvo R$ 10/peça (máx R$ 12)
   - Prazo: Máx 60 dias (ideal 45)
   - Pagamento: Definir condições
   - Incoterm: FOB? CIF?

3. **Sansom:** Fechar pedido
   - Prazo: Até 21/Jan
   - Emitir PO (Purchase Order)
   - Confirmar data embarque
   - Confirmar data chegada Brasil

4. **Sansom:** Logística importação
   - Definir despachante aduaneiro
...
### 🟡 PRIORIDADE 3: Planilha Financeira Detalhada
...
1. **Gassen:** Levantar custos fábrica Jean
   ...
   - Custo real por peça produzida
   - Lucro mínimo fábrica (5-10%)

2. **Sansom:** Validar custos China
   - Prazo: Até 18/Jan
   - Preço final tecido (incluindo frete/impostos)
   - Custo por kit (3 peças)

3. **Gassen:** Estruturar planilha
   - Prazo: Até 19/Jan
   - Criar modelo no Excel/Google Sheets
   - Fórmulas automáticas
   - Cenários: conservador, realista, otimista

4. **Sansom:** Revisar e validar
   - Prazo: Até 21/Jan
   - Ajustar números
...
- [ ] Validação Sansom (até 21/Jan)

---

### 🟡 PRIORIDADE 4: Reunião Titanium (Comercial)
...
1. **Gassen:** Agendar reunião
   ...
   - Objetivo: Validar serviço (R$ 60k/mês)

2. **Reunião:** Validar escopo
   - Prazo: Até 28/Jan
   - Confirmar:
     - Custo: R$ 60k/mês (fixo)
     - Tráfego pago: Separado (variável R$ 40-100k)
     - Escopo: Campanhas, CRO, SAC (indicação equipe)
     - Tempo setup: 1 mês
     - Contrato: Sem exclusividade, 3 meses aviso prévio

3. **Gassen:** Apresentar modelo Atara
   - Objetivo: Replicar estratégia validada
...
## 📋 SEMANA 3-4 (29/JAN-11/FEV) - FORMALIZAÇÃO

### 🔴 PRIORIDADE 1: Assinar Contratos
...
1. **Dr. Alexandre:** Finalizar contratos
   - Prazo: Até 04/Fev
   - Contrato Social
   - Prestação Serviço (Jean)
   - Outros necessários

2. **Todos:** Revisar contratos
   - Prazo: Até 07/Fev
   - Sansom revisa
   - Gassen+Kris revisam
   - Jean revisa (prestação serviço)

3. **Todos:** Assinar contratos
   - Prazo: Até 11/Fev
   - Presencial ou digital (definir)
   - Registrar em cartório

4. **Dr. Alexandre:** Registrar empresa
   - Prazo: Até 11/Fev
   - CNPJ (se novo)
   - Inscrição Estadual
...
- [ ] Empresa registrada (até 11/Fev)

---

### 🟡 PRIORIDADE 2: Definir Investimento Inicial
...
3. **Todos:** Definir modelo de aporte
   - Prazo: Até 11/Fev
   - Opção A: Integral início (R$ 2,6M)
   - Opção B: Parcelado 6 meses (R$ 433k/mês cada)
   - Opção C: Misto (parte inicial + mensal)

4. **Dr. Alexandre:** Formalizar aportes
   - Definir em contrato
...
### 🟡 PRIORIDADE 3: Contratações Iniciais
...
1. **Contador E-commerce** (PJ ou CLT)
   ...
   - Regime MG (2,5% imposto)

2. **Logística/Expedição** (indicação Titanium)
   - Sistema etiquetas
   - Controle estoque
   - Despacho/rastreio

3. **Atendimento/SAC** (indicação Titanium)
...
1. **Gassen:** Buscar contador especializado
   ...
   - Validar expertise e-commerce
   - Negociar valores

2. **Titanium:** Indicar profissionais logística/SAC
   - Prazo: Até 04/Fev
   - PJ ou CLT?
   - Valores?
   - Disponibilidade?

3. **Todos:** Contratar posições críticas
   - Prazo: Até 11/Fev
...
## 📋 FEVEREIRO 2026 - SETUP OPERACIONAL

### 🔴 PRIORIDADE 1: Onboarding Titanium
...
2. **Semana 3:** Setup Shopify
   - Estrutura loja
   - Layout/design (inspiração Atara)
   - Páginas produto (kit 3 peças)
   - Checkout otimizado
   - Integrações (pagamento, frete)

3. **Semana 4:** Campanhas e Testes
   - Criativos (fotos/vídeos)
   - Copy anúncios
   - Segmentação público
   - Testes A/B iniciais
...
- [ ] Testes iniciais rodando (Semana 4)

---

### 🟡 PRIORIDADE 2: Preparação Fábrica Jean
...
2. **Jean:** Preparar para escala
   - Prazo: Até 28/Fev
   - Contratar mais costureiras? (se necessário)
   - Organizar layout produção
   - Processos/procedimentos

3. **Jean:** Testar produção kit
   - Prazo: Até 28/Fev
   - Protótipo kit 3 peças
   - Validar qualidade
   - Calcular tempo produção/kit
   - Confirmar capacidade 27k kits/mês

4. **Gassen:** Estruturar contrato prestação serviço
   - Prazo: Até 11/Fev
   - Custo + 5-10% lucro mínimo
   - Exclusividade 100%
...
- [ ] Contrato prestação serviço (até 11/Fev)

---

### 🟡 PRIORIDADE 3: Confirmar Tecido China
...
2. **Sansom:** Preparar importação
   - Prazo: Até 28/Fev
   - Despachante aduaneiro contratado
   - Documentação pronta
   - Pagamento impostos/taxas

3. **Sansom:** Confirmar logística
   - Prazo: Até 28/Fev
   - Transporte porto → MG
...
- [ ] Previsão chegada MG (até 28/Fev)

---

## 📋 MARÇO-ABRIL 2026 - PRODUÇÃO ESTOQUE

### 🔴 PRIORIDADE 1: Receber Tecido China
...
4. Conferência qualidade/quantidade
5. Armazenagem adequada

---

### 🔴 PRIORIDADE 2: Produzir Estoque Inicial
...
### 🟡 PRIORIDADE 3: Finalizar Shopify
...
4. Testes finais (checkout, pagamento, frete)
5. Integrações (ERP, estoque, logística)
...
1. **Titanium:** Ativar campanhas
   ...
   - Criativos testados
   - Budget diário controlado

2. **Gassen:** Monitorar conversões
   - Taxa conversão
   - CAC (Custo Aquisição Cliente)
   - LTV (Lifetime Value)
   - ROI tráfego

3. **Jean:** Produção sob demanda
   - Ajustar velocidade conforme vendas
   - Manter buffer estoque
   - Qualidade consistente

4. **Todos:** Reunião semanal
   - Métricas
   - Problemas
   - Ajustes estratégia
   - Decisões rápidas
